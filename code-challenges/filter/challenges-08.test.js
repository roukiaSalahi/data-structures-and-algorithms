...
Write a function named sayHello, that sends the message 'Hello from the back-end' when a user 
hits the `/hello` route.
...
const filterStringsWithVowels = (arr) => {
  ...
  let vowelsArr = arr.filter(element=>{
    return (element.match(regix))
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let returendValues = arr.filter(element=>{
