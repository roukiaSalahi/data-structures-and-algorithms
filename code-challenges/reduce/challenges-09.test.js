...
Next, write a function named getCurrentEvents that takes in the request 
and response as parameters. This function should call the mapCurrentEvents 
function and send the result to the front-end.
...
Write a function named reversedString that takes in a string and returns a 
...
const reversedString = (str) => {
    ...
    let reversedStr = arrStr.reduce((newString, currentString) => {
